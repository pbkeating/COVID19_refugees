...
#SBATCH --job-name=kutupalong_camp_mid
...
#SBATCH --error=outputJob_mid.err
#SBATCH --output=outputJob_mid.out
...
R -n 10 CMD BATCH '--args R0_val="mid" n.Rs=20 n.sims=100 cores=10 ' ./R/RunSEIR_server.R ./"${dirname}"/kutupalong_mid.Rout 
