...
plot_age <- ggplot(pr_age10, aes(x=age_group, y=p)) +
                    ...
                    xlab("Proportion") +
                    ylab("Age (y)") + 
  ggtitle("Figure 1.", subtitle= "Age distribution of the Dagahaley camp and the expected proportion of infections that will result in severe disease, compared across several countries and Dagahaley camp, adjusted for age. These estimates inform the proportion hospitalized, admitted to intensive care, placed on ventilation, and who die.") + 
